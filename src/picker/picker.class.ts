...
class Picker {
  ...
  initScrollParams(): void {
    ...
    let curIndex = findIndexOfEnabledOption(
      this.options.PickerColumns,
  ...
  endScroll(): void {
    ...
    curIndex = findIndexOfEnabledOption(this.options.PickerColumns, curIndex, this.options.keys);
