...
-- | -- | -- | -- | --
closable | Boolean / Object / Slot / Function | false | Typescript：`boolean \| object \| TNode`。[see more ts definition](https://github.com/Tencent/tdesign-mobile-vue/blob/develop/src/common.ts) | N
