<template>
  <div class="tdesign-mobile-demo">
    ...
    <tdesign-demo-block summary="带数值单游标滑块">
      <labelDemo />
    </tdesign-demo-block>
    <tdesign-demo-block summary="带刻度单游标滑块">
      <stepDemo />
    </tdesign-demo-block>
    <tdesign-demo-block summary="滑块禁用状态" title="02 组件状态">
      <disableDemo />
    </tdesign-demo-block>
    <tdesign-demo-block summary="胶囊型滑块" title="03 特殊样式">
      <capsuleDemo />
    </tdesign-demo-block>
