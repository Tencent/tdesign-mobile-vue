...
cover | Slot / Function | - | 支持自定义覆盖在图片预览最上方的内容。TS 类型：`TNode`。[通用类型定义](https://github.com/Tencent/tdesign-mobile-vue/blob/develop/src/common.ts) | N
