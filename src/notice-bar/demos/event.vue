<template>
  <div class="noticebar-demo">
    <tdesign-demo-block title="事件">
      <t-button @click="handleChange">显示/隐藏</t-button>
      <t-notice-bar
        :visible="visible"
        ...
        @click="handleClick"
        @change="(value) => handleConsole(value)"
      />
    </tdesign-demo-block>
  </div>
</template>
...
<script lang="ts">
import { reactive, defineComponent, toRefs, h, watch, ref } from 'vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleConsole = (value: boolean) => {
      console.log(value);
    };
