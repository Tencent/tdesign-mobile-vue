...
popupProps | Object | {} | Typescript：`PopupProps`，[Popup API Documents](./popup?tab=api)。[see more ts definition](https://github.com/hensonjunyuan/tdesign-mobile-vue/tree/develop/src/action-sheet/type.ts) | N
